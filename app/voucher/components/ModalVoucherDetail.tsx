...
export const ModalVoucherDetail: React.FC<Props> = ({
  open,
  onClose,
  voucher,
}) => {
            ...
            <div className="mb-5">
              <div className="bg-white p-4 ">
                ...
                <div className="w-[90%] mx-auto text-center  p-4 mb-2 rounded-sm">
                  ...
                  <div className="mb-4">
                    <p className="text-xl font-medium text-[#4DCB44]">
                      {voucher.title}
                    </p>
                    <p className="text-sm text-[#7180A4]">
                      Áp dụng cho đơn hàng online
                    </p>
                  </div>
                  ...
                  <div className="w-[90%] mx-auto bg-[#F8FAFC] shadow-sm rounded-sm">
                    <div className="p-3">
                      ...
                      <p className="text-sm text-[#7180A4] mb-2">
                        {voucher.start_date} - {voucher.end_date}
                      </p>
                      <div className="w-full flex justify-center">
                        <p className="w-[30%]  text-[13px] border rounded-full border-[#4DCB44] bg-[#EBFAEA] text-[#4DCB44]">
                          Giao hàng
                        </p>
                      </div>
                    </div>
              ...
              <div className="px-6 py-4 bg-white p-3 shadow-sm">
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: voucher.content || "<p>Không có nội dung</p>",
                  }}
                />
              </div>
